...
// Source: domain/entity/user/interface.go
...
import (
	...
	entity "github.com/samuelssantos/user-service/domain/entity"
	user "github.com/samuelssantos/user-service/domain/entity/user"
	reflect "reflect"
)
...
func (m *MockReader) Get(id entity.ID) (*user.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockReader) Search(query string) ([]*user.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockReader) List() ([]*user.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockWriter) Create(e *user.User) (entity.ID, error) {
	m.ctrl.T.Helper()
...
func (m *MockWriter) Update(e *user.User) error {
	m.ctrl.T.Helper()
...
// Get mocks base method
func (m *Mockrepository) Get(id entity.ID) (*user.User, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", id)
	ret0, _ := ret[0].(*user.User)
	ret1, _ := ret[1].(error)
...
// Search mocks base method
func (m *Mockrepository) Search(query string) ([]*user.User, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Search", query)
	ret0, _ := ret[0].([]*user.User)
	ret1, _ := ret[1].(error)
...
// Create mocks base method
func (m *Mockrepository) Create(e *user.User) (entity.ID, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", e)
	ret0, _ := ret[0].(entity.ID)
	ret1, _ := ret[1].(error)
...
// Update mocks base method
func (m *Mockrepository) Update(e *user.User) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Update", e)
	ret0, _ := ret[0].(error)
	return ret0
...
// Get mocks base method
func (m *MockManager) Get(id entity.ID) (*user.User, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", id)
	ret0, _ := ret[0].(*user.User)
	ret1, _ := ret[1].(error)
...
// Search mocks base method
func (m *MockManager) Search(query string) ([]*user.User, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Search", query)
	ret0, _ := ret[0].([]*user.User)
	ret1, _ := ret[1].(error)
...
// List mocks base method
func (m *MockManager) List() ([]*user.User, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "List")
	ret0, _ := ret[0].([]*user.User)
	ret1, _ := ret[1].(error)
...
// Create mocks base method
func (m *MockManager) Create(e *user.User) (entity.ID, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", e)
	ret0, _ := ret[0].(entity.ID)
	ret1, _ := ret[1].(error)
...
// Update mocks base method
func (m *MockManager) Update(e *user.User) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Update", e)
	ret0, _ := ret[0].(error)
	return ret0
